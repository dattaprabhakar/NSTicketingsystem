...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and user.check_password(form.password.data):
            ...
            return redirect(next_p or url_for('main.dashboard'))
        else:
            flash('Login Fail. Check credentials.', 'danger')
